...
if __name__ == '__main__':
	...
	while True:
		...
		if 'hey sapphire' in query:
			indx = query.lower().split().index('sapphire')
			query = ' '.join(query.split()[indx + 1:])
			...
			if 'wikipedia' in query:
				...
				#launch URL
				driver.get("https://huggingface.co/spaces/Intel/Stable-Diffusion-Side-by-Side")
				time.sleep(5)
				frame = driver.find_element(By.XPATH, "/html/body/div/main/div/iframe")
				driver.switch_to.frame(frame)
				element = driver.find_element(By.XPATH, '/html/body/gradio-app/div/div[2]/div/div/div[3]/div[2]/div/div/div[1]/div[1]/div[1]/label/textarea')
				element.clear()
				element.send_keys(' '.join(query))
				element = driver.find_element(By.XPATH, '/html/body/gradio-app/div/div[2]/div/div/div[3]/div[2]/div/div/div[1]/div[1]/div[3]/div[2]/div/input')
				element.clear()
				...
				element.click()
				time.sleep(15)
				l = driver.find_element(By.XPATH, '/html/body/gradio-app/div/div[2]/div/div/div[3]/div[2]/div/div/div[2]/div[1]/img')
